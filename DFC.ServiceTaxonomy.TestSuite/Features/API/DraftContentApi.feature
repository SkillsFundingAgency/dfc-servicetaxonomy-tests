...
Scenario: Request an NCS item by invalid Type
	...
	Given I make a request to the Draft content API to retrive all "__TYPE__" items
...
Scenario: Request an NCS item by invalid Id
	...
	And I delete Graph data for content type "__TYPE__"
	Given I make a request to the Draft content API to retrive item 1
	Then the response code is 404

@ContentApi
Scenario: Request all NCS items of a type
	Given I define a test type and call it "__TYPE__"
	And I create a Draft "__TYPE__" item with the following data
	| Title      | Content          |
	| First Item | <p>Something</p> |
	And I create a Draft "__TYPE__" item with the following data
	| Title    | Content               |
...
Scenario: Request an item with a related item
	...
	And I create an item of "__TYPE__" related by "hasRelationship" to item 1 with the following data
	| Title    | Content               | CreatedDate             | ModifiedDate            |
	| 2nd Item | <p>Something else</p> | 2020-06-17T16:04:41.68Z | 2020-06-17T16:04:41.68Z |
	Given I make a request to the content API to retrive item 1
	When I build the expected response for item 1
...
Scenario: Request an item with a number of related items
	...
	And I create a "__TYPEA__" item with the following data
	| Title      | Content          | CreatedDate             | ModifiedDate            |
	| First Item | <p>Something</p> | 2020-06-17T16:04:41.68Z | 2020-06-17T16:04:41.68Z |
	And I create an item of "__TYPEA__" related by "hasRelationship" to item 1 with the following data
	| Title    | Content               | CreatedDate             | ModifiedDate            |
	| 2nd Item | <p>Something else</p> | 2020-06-17T16:04:41.68Z | 2020-06-17T16:04:41.68Z |
	And I create an item of "__TYPEA__" related by "hasOtherRelationship" to item 1 with the following data
	| Title    | Content               | CreatedDate             | ModifiedDate            |
...
Scenario: Request an item with a number of related items of different types
	...
	| Title    | Content               | CreatedDate             | ModifiedDate            |
	| 3rd Item | <p>Something more</p> | 2020-06-17T16:04:41.68Z | 2020-06-17T16:04:41.68Z |
	And I create an item of "__TYPEB__" related by "hasOtherRelationship" to item 1 with the following data
	| Title    | Content                    | CreatedDate             | ModifiedDate            |
...
Scenario: Request an item with an incoming relationship
	...
	| Title    | Content               | CreatedDate             | ModifiedDate            |
	| 2nd Item | <p>Something else</p> | 2020-06-17T16:04:41.68Z | 2020-06-17T16:04:41.68Z |
	Given I make a request to the content API to retrive item 2
