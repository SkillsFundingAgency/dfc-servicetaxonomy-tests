...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Editor/Pages", "Pages-existing_published_shared_content", null, ProgrammingLanguage.CSharp, new string[] {
                        "webtest"});
...
#line 8
 testRunner.And("I Enter the following form data for \"SharedContent\"", ((string)(null)), table268, "And ");
#line hidden
#line 11
...
#line hidden
        ...
        public virtual void AddAnPublishedSharedItemToANewPageAndPublishIt_UnpublishTheSharedContentItemThenThePage()
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Add an published shared item to a new page and publish it. Unpublish the shared c" +
                    "ontent item then the page", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 17
...
#line hidden
                ...
                table269.AddRow(new string[] {
                            "My Test Page"});
#line 20
 testRunner.And("I Enter the following form data for \"Page\"", ((string)(null)), table269, "And ");
#line hidden
#line 23
...
#line 27
 testRunner.And("the \"preview\" graph matches the expect results using the \"page_with_shared_conten" +
                        "t\" query", ((string)(null)), table270, "And ");
#line hidden
...
#line 30
 testRunner.And("the \"publish\" graph matches the expect results using the \"page_with_shared_conten" +
                        "t\" query", ((string)(null)), table271, "And ");
#line hidden
#line 35
 testRunner.Given("I Navigate to \"/Admin/Contents/ContentTypes/Page/Create\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
...
#line 39
 testRunner.And("the \"preview\" graph matches the expect results using the \"page_with_shared_conten" +
                        "t\" query", ((string)(null)), table272, "And ");
#line hidden
...
#line 45
 testRunner.And("the \"publish\" graph matches the expect results using the \"shared_content_by_uri\" " +
                        "query", ((string)(null)), table274, "And ");
#line hidden
#line 50
...
#line 58
 testRunner.And("the \"publish\" graph matches the expect results using the \"page_by_uri\" query and " +
                        "the \"PageUri\" Uri", ((string)(null)), table276, "And ");
#line hidden
...
#line hidden
        ...
        public virtual void AddAnPublishedSharedItemToANewPageAndPublishIt_UnpublishThePageItemThenTheSharedContent()
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Add an published shared item to a new page and publish it. Unpublish the page ite" +
                    "m then the shared content", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 68
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
...
#line hidden
                ...
                table278.AddRow(new string[] {
                            "My Test Page"});
#line 71
 testRunner.And("I Enter the following form data for \"Page\"", ((string)(null)), table278, "And ");
#line hidden
#line 74
 testRunner.And("I select the default page location", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 78
 testRunner.And("the \"preview\" graph matches the expect results using the \"page_with_shared_conten" +
                        "t\" query", ((string)(null)), table279, "And ");
#line hidden
...
#line 81
 testRunner.And("the \"publish\" graph matches the expect results using the \"page_with_shared_conten" +
                        "t\" query", ((string)(null)), table280, "And ");
#line hidden
#line 86
...
#line 91
 testRunner.And("the \"preview\" graph matches the expect results using the \"page_with_shared_conten" +
                        "t\" query and the \"PageUri\" Uri", ((string)(null)), table281, "And ");
#line hidden
...
#line 94
 testRunner.And("the \"publish\" graph matches the expect results using the \"page_by_uri\" query and " +
                        "the previous URI", ((string)(null)), table282, "And ");
#line hidden
                ...
                table283.AddRow(new string[] {
                            "0"});
#line 97
 testRunner.And("the \"publish\" graph matches the expect results using the \"widget_by_uri\" query", ((string)(null)), table283, "And ");
#line hidden
...
#line 100
 testRunner.And("the \"publish\" graph matches the expect results using the \"shared_content_by_uri\" " +
                        "query and the \"SharedContentUri\" Uri", ((string)(null)), table284, "And ");
#line hidden
#line 105
 testRunner.Given("I Navigate to \"/Admin/Contents/ContentTypes/Page/Create\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
...
#line 109
 testRunner.And("the \"preview\" graph matches the expect results using the \"page_with_shared_conten" +
                        "t\" query and the \"SharedHTMLUri\" Uri", ((string)(null)), table285, "And ");
#line hidden
...
#line 112
 testRunner.And("the \"publish\" graph matches the expect results using the \"page_with_wiget_only\" q" +
                        "uery and the \"SharedHTMLUri\" Uri", ((string)(null)), table286, "And ");
#line hidden
...
#line 115
 testRunner.And("the \"publish\" graph matches the expect results using the \"shared_content_by_uri\" " +
                        "query and the \"SharedHTMLUri\" Uri", ((string)(null)), table287, "And ");
#line hidden
            }
            this.ScenarioCleanup();
        }
        ...
        public virtual void AttemptToDeleteASharedContentItemWhichIsInUseOnAPage()
        {
            string[] tagsOfScenario = new string[] {
                    "ignore"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Attempt to delete a shared content item which is in use on a page", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 120
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
...
#line 130
 testRunner.And("the \"preview\" graph matches the expect results using the \"page_with_shared_conten" +
                        "t\" query", ((string)(null)), table289, "And ");
#line hidden
...
#line 133
 testRunner.And("the \"publish\" graph matches the expect results using the \"page_with_shared_conten" +
                        "t\" query", ((string)(null)), table290, "And ");
#line hidden
#line 138
 testRunner.Given("I Navigate to \"/Admin/Contents/ContentTypes/Page/Create\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
...
#line 142
 testRunner.And("the \"preview\" graph matches the expect results using the \"page_with_shared_conten" +
                        "t\" query", ((string)(null)), table291, "And ");
#line hidden
...
#line 148
 testRunner.And("the \"publish\" graph matches the expect results using the \"shared_content_by_uri\" " +
                        "query", ((string)(null)), table293, "And ");
#line hidden
            }
            this.ScenarioCleanup();
        }
