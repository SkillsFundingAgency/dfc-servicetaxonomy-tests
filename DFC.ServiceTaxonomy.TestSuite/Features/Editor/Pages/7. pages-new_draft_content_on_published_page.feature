...
#	Then the item is published succesfully
#	And the "preview" graph matches the expect results using the "page_with_shared_with_title_content" query and the "SharedContentUri" Uri
#	| sharedContent             |
...
Scenario: Delete the page
	...
	| widgets_found |
	| 0             |
	And the "preview" graph matches the expect results using the "shared_content_title_by_uri" query and the "SharedContentUri" Uri
	| sharedContent             |
	| __PREFIX__Updated Content |
