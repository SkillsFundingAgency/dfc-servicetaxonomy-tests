...
#line 9
 testRunner.And("I Enter the following form data for \"SharedContent\"", ((string)(null)), table306, "And ");
#line hidden
#line 12
...
#line hidden
            ...
            table307.AddRow(new string[] {
                        "My Test Page"});
#line 19
 testRunner.And("I Enter the following form data for \"Page\"", ((string)(null)), table307, "And ");
#line hidden
#line 22
...
#line 26
 testRunner.And("the \"preview\" graph matches the expect results using the \"page_with_shared_conten" +
                    "t\" query and the \"PageUri\" Uri", ((string)(null)), table308, "And ");
#line hidden
...
#line 29
 testRunner.And("the \"publish\" graph matches the expect results using the \"page_by_uri\" query and " +
                    "the \"PageUri\" Uri", ((string)(null)), table309, "And ");
#line hidden
#line 32
...
#line 41
 testRunner.Then("within expected timescales the \"publish\" graph matches the expect results using t" +
                        "he \"page_by_uri\" query and the \"PageUri\" Uri", ((string)(null)), table310, "Then ");
#line hidden
#line 45
 testRunner.Given("I Navigate to \"/Admin/Contents/ContentItems\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
...
#line 53
 testRunner.Then("the \"publish\" graph matches the expect results using the \"page_by_uri\" query and " +
                        "the \"PageUri\" Uri", ((string)(null)), table311, "Then ");
#line hidden
#line 57
 testRunner.Given("I Navigate to \"/Admin/Contents/ContentItems\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
...
#line 64
 testRunner.Then("within expected timescales the \"publish\" graph matches the expect results using t" +
                        "he \"page_by_uri\" query and the \"PageUri\" Uri", ((string)(null)), table312, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
