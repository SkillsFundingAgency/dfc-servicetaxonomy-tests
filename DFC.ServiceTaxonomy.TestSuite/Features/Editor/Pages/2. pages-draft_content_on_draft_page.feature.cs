...
#line 8
 testRunner.And("I Enter the following form data for \"SharedContent\"", ((string)(null)), table126, "And ");
#line hidden
#line 11
...
#line hidden
            ...
            table127.AddRow(new string[] {
                        "My Test Page"});
#line 18
 testRunner.And("I Enter the following form data for \"Page\"", ((string)(null)), table127, "And ");
#line hidden
#line 21
...
#line 40
 testRunner.And("the \"publish\" graph matches the expect results using the \"page_with_wiget_only\" q" +
                        "uery and the \"PageUri\" Uri", ((string)(null)), table130, "And ");
#line hidden
            }
...
#line 53
 testRunner.And("the \"preview\" graph matches the expect results using the \"widget_by_uri\" query an" +
                        "d the \"PageUri\" Uri", ((string)(null)), table132, "And ");
#line hidden
...
#line 56
 testRunner.And("the \"preview\" graph matches the expect results using the \"page_by_uri\" query and " +
                        "the \"PageUri\" Uri", ((string)(null)), table133, "And ");
#line hidden
...
#line 59
 testRunner.And("the \"preview\" graph matches the expect results using the \"widget_by_uri\" query an" +
                        "d the \"PageUri\" Uri", ((string)(null)), table134, "And ");
#line hidden
            }
            this.ScenarioCleanup();
        }
