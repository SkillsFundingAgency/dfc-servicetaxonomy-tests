...
#line 9
 testRunner.And("I Enter the following form data for \"SharedContent\"", ((string)(null)), table217, "And ");
#line hidden
#line 12
...
#line hidden
            ...
            table218.AddRow(new string[] {
                        "My Test Page"});
#line 19
 testRunner.And("I Enter the following form data for \"Page\"", ((string)(null)), table218, "And ");
#line hidden
#line 22
...
#line 37
 testRunner.And("I Enter the following form data for \"Page\"", ((string)(null)), table221, "And ");
#line hidden
#line 40
...
#line 49
 testRunner.And("I Enter the following form data for \"Page\"", ((string)(null)), table223, "And ");
#line hidden
#line 52
 testRunner.When("I save the draft item", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line 67
 testRunner.And("the \"preview\" graph matches the expect results using the \"page_with_shared_conten" +
                        "t\" query and the \"PageUri\" Uri", ((string)(null)), table225, "And ");
#line hidden
...
#line 70
 testRunner.And("the \"publish\" graph matches the expect results using the \"page_with_shared_conten" +
                        "t\" query and the \"PageUri\" Uri", ((string)(null)), table226, "And ");
#line hidden
            }
...
#line 80
 testRunner.And("the \"preview\" graph matches the expect results using the \"page_with_shared_conten" +
                        "t\" query and the \"PageUri\" Uri", ((string)(null)), table227, "And ");
#line hidden
...
#line 83
 testRunner.And("the \"publish\" graph matches the expect results using the \"page_with_shared_conten" +
                        "t\" query and the \"PageUri\" Uri", ((string)(null)), table228, "And ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line 120
 testRunner.And("the \"preview\" graph matches the expect results using the \"page_by_uri\" query and " +
                        "the \"PageUri\" Uri", ((string)(null)), table233, "And ");
#line hidden
...
#line 123
 testRunner.And("the \"preview\" graph matches the expect results using the \"widget_by_uri\" query an" +
                        "d the \"PageUri\" Uri", ((string)(null)), table234, "And ");
#line hidden
...
#line 126
 testRunner.And("the \"publish\" graph matches the expect results using the \"page_by_uri\" query and " +
                        "the \"PageUri\" Uri", ((string)(null)), table235, "And ");
#line hidden
...
#line 129
 testRunner.And("the \"publish\" graph matches the expect results using the \"widget_by_uri\" query an" +
                        "d the \"PageUri\" Uri", ((string)(null)), table236, "And ");
#line hidden
...
#line 132
 testRunner.And("the \"preview\" graph matches the expect results using the \"shared_content_title_by" +
                        "_uri\" query and the \"SharedContentUri\" Uri", ((string)(null)), table237, "And ");
#line hidden
...
#line 135
 testRunner.And("the \"publish\" graph matches the expect results using the \"shared_content_title_by" +
                        "_uri\" query and the \"SharedContentUri\" Uri", ((string)(null)), table238, "And ");
#line hidden
            }
            this.ScenarioCleanup();
        }
