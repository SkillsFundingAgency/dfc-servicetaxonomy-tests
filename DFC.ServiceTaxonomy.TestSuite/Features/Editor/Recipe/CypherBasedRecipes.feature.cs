...
#line hidden
            ...
            table343.AddRow(new string[] {
                        ...
                        "$\"http://data.europa.eu/esco/occupation/{ContentType.ToLowerInvariant()}/{Value}\"" +
                            ""});
#line 17
 testRunner.And("I set the following field values", ((string)(null)), table343, "And ");
#line hidden
#line 25
...
#line hidden
            ...
            table344.AddRow(new string[] {
                        ...
                        "Numeric Field"});
#line 26
 testRunner.And("I add the following fields", ((string)(null)), table344, "And ");
#line hidden
        }
...
#line hidden
                ...
                table345.AddRow(new string[] {
                            ...
                            "test description"});
#line 36
 testRunner.And("I confirm the following \"test__CypherItem\" data is preset in the Graph Database", ((string)(null)), table345, "And ");
#line hidden
#line 43
...
#line hidden
                ...
                table346.AddRow(new string[] {
                            ...
                            "Test Thing 1"});
#line 45
 testRunner.And("the values displayed in the editor match", ((string)(null)), table346, "And ");
#line hidden
            }
