...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Editor/Events", "ContentChangeEvents_EdgeCases", "\tScenarios that don\'t fit into another section", ProgrammingLanguage.CSharp, new string[] {
                        "webtest"});
        ...
        public virtual void _22_PublishDraftIsSelectedFromTheContentItemListViewForAnExistingPublishedItemWithoutChanges()
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("22. Publish draft is selected from the content item list view for an existing pub" +
                    "lished item without changes", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 9
