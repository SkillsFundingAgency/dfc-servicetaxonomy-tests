...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Editor/PredefinedTypes", "Page", null, ProgrammingLanguage.CSharp, new string[] {
                        "webtest"});
...
#line hidden
        ...
        public virtual void AddANewPageWithAnHtmlItem()
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Add a new page with an html item", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 8
...
#line hidden
                ...
                table305.AddRow(new string[] {
                            "My Test Page"});
#line 13
 testRunner.And("I Enter the following form data for \"Page\"", ((string)(null)), table305, "And ");
#line hidden
#line 17
...
#line 23
 testRunner.Then("the preview and publish graphs returns the expected results using the \"page_with_" +
                        "html\" query", ((string)(null)), table306, "Then ");
#line hidden
            }
